defmodule TripPlan.Api.OpenTripPlanner.ParserTest do
  ...
  describe "parse_nearby_json/1" do
    ...
    test "sorts all stops by distance and converts into named positions" do
      stops =
        [
            %NamedPosition{# 635 meters from query
                stop_id: "7094",
                name: "Terminal C - Departures Level",
                latitude: 42.366635,
                longitude: -71.017167,
            },
            %NamedPosition{# 642 meters from query
                stop_id: "17094",
                name: "Terminal C - Arrivals Level",
                latitude: 42.366494,
                longitude: -71.017289,
            },
            %NamedPosition{# 717 meters from query
                stop_id: "Logan-C",
                name: "Logan Airport Terminal C",
                latitude: 42.367271,
                longitude: -71.017957,
            },
            %NamedPosition{# 782 meters from query
                stop_id: "17093",
                name: "Terminal B Stop 2 - Arrivals Level",
                latitude: 42.361657,
                longitude: -71.017833,
            },
            %NamedPosition{# 830 meters from query
                stop_id: "27092",
                name: "Terminal B Stop 1 - Arrivals Level",
                latitude: 42.3621,
                longitude: -71.01882,
            },
            %NamedPosition{# 859 meters from query
                stop_id: "Logan-B",
                name: "Logan Airport Terminal B",
                latitude: 42.361302,
                longitude: -71.018648,
            },
            %NamedPosition{# 923 meters from query
                stop_id: "17091",
                name: "Terminal A",
                latitude: 42.364612,
                longitude: -71.020862,
            },
            %NamedPosition{# 980 meters from query
                stop_id: "17095",
