defmodule Fares.RetailLocationsDataExtractorTest do
  ...
  @test_output_path Path.join(System.tmp_dir!, @test_output_file)
  @test_input_path Path.join(System.tmp_dir!, "content.csv")
  ...
  describe "mix task" do
    ...
    test "writes extracted data to a valid json file" do
      ...
      location
      |> Poison.encode
      |> Extractor.write_to_file(@test_output_path)
