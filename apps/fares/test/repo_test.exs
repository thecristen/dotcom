defmodule Fares.RepoTest do
  ...
  describe "filter/1" do
    @fares [
      %Fare{mode: :commuter, cents: 225, duration: :single_trip, name: :zone_1a, media: [:commuter_ticket], reduced: nil},
      %Fare{mode: :commuter, cents: 225, duration: :single_trip, name: :zone_1a, media: [:commuter_ticket],
            reduced: :student},
      %Fare{mode: :commuter, cents: 225, duration: :month, name: :zone_2, media: [:commuter_ticket], reduced: :student},
      %Fare{mode: :commuter, cents: 625, duration: :month, name: :zone_3, media: [:charlie_card], reduced: nil},
