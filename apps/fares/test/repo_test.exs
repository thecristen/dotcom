defmodule Fares.RepoTest do
  ...
  describe "filter/1" do
    @fares [
      ...
      %Fare{mode: :commuter_rail, cents: 225, duration: :single_trip, name: {:zone, "1A"}, media: [:commuter_ticket],
            reduced: :student},
      %Fare{mode: :commuter_rail, cents: 225, duration: :month, name: {:zone, "2"}, media: [:commuter_ticket], reduced: :student},
      %Fare{mode: :commuter_rail, cents: 625, duration: :month, name: {:zone, "3"}, media: [:charlie_card], reduced: nil},
      %Fare{mode: :commuter_rail, cents: 1025, duration: :month, name: {:zone, "6"}, media: [:commuter_ticket, :cash], reduced: nil},
