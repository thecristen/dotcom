...
FETCH_SQL = b"""select convert(varchar(30), date_created, 120), content_id, content_html, "%s" from dbo.content where xml_config_id="60" and content_type != "3"
""" % SEPARATOR
...
def to_dict(tree):
    d = {}
    for child in tree:
        d[child.tag.lower()] = element_to_string(child)
    return d
