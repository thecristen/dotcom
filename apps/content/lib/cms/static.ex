defmodule Content.CMS.Static do
  ...
  def view("/recent-news", [current_id: id]) do
    ...
    recent_news = Enum.take(filtered_recent_news, NewsEntry.number_of_recent_news_suggestions(:show))

    {:ok, recent_news}
  end
  def view("/recent-news", _) do
    {:ok, Enum.take(news_response(), NewsEntry.number_of_recent_news_suggestions(:show))}
  end
