...
describe("QueryStringHelpers", () => {
  ...
  describe("parseParams", () => {
    ...
    it("encodes characters", () => {
      expect(QueryStringHelpers.parseParams({foo: "bar & baz"})).to.equal("?foo=bar%20%26%20baz");
    });
  ...
  describe("parseQuery", () => {
    ...
    it("decodes characters", () => {
      expect(QueryStringHelpers.parseQuery("?foo=bar%20%26%20baz+bat&bing=bong")).to.deep.equal({foo: "bar & baz bat", bing: "bong"});
    });
