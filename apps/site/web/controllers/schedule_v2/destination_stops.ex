defmodule Site.ScheduleV2Controller.DestinationStops do
  @moduledoc """
  ...
  defp excluded_red_destination_stops(%Stops.Stop{id: origin_id}) when origin_id in @braintree_stops do
    @ashmont_stops
  end
  defp excluded_red_destination_stops(%Stops.Stop{id: origin_id}) when origin_id in @ashmont_stops do
    @braintree_stops
  end
