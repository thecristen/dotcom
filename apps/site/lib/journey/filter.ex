defmodule Journey.Filter do
  ...
  @spec remove_departure_schedules_before_predictions([Journey.t], DateTime.t | nil) :: [Journey.t]
  ...
  @spec remove_departure_schedules_before_last_trip([Journey.t], DateTime.t | nil) :: [Journey.t]
  ...
  @spec find_max_earlier_departure_schedule_time([Journey.t], DateTime.t) :: DateTime.t | nil
  def find_max_earlier_departure_schedule_time(journeys, time) do
    only_past_schedules = journeys
