defmodule SiteWeb.ScheduleController.FinderApi do
  ...
  def departures(conn, %{"stop" => stop_id} = params) do
    ...
    # Add a field with the boolean result of has_service/1 to journeys before writing out json

    json(conn, journeys)
  end

  defp has_service(route_id) do
    # the plan here was to query
    # Schedules.HoursOfOperation.hours_of_operation/1
    # and pattern match/destructure the result to determine whether
    # there was service on a given day
  end
