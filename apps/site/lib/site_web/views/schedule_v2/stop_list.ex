defmodule SiteWeb.ScheduleV2View.StopList do
  ...
  def view_branch_link(branch_name, assigns, target_id, branch_display) do
    SiteWeb.ScheduleV2View.render("_stop_list_expand_link.html",
                               Map.merge(assigns,
  ...
  def render_row(row, assigns) do
    ...
    SiteWeb.ScheduleV2View.render("_stop_list_row.html", assigns)
  end
