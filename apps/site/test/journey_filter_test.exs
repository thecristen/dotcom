defmodule JourneyListFilterTest do
  ...
  describe "Journey.find_max_earlier_departure_schedule_time/2" do
    test "finds max earlier departure time" do
      ...
      actual = find_max_earlier_departure_schedule_time([journey1, journey2, journey3], ~N[2017-03-01T08:10:00])
      assert  actual == ~N[2017-03-01T08:00:00]

      # [ 7:00, 8:00, 9:00 ] @ 9:10 -> nil since the current time is after the last time
      assert find_max_earlier_departure_schedule_time([journey1, journey2, journey3], ~N[2017-03-01T09:10:00]) == nil

      # [ 7:00, 8:00, 9:00 ] @ 7:00 -> 7:00
      earlier_time = ~N[2017-03-01T07:00:00]
      assert find_max_earlier_departure_schedule_time([journey1, journey2, journey3], earlier_time) == earlier_time

      # [ 7:00, 8:00, 9:00 ] @ 6:59 -> nil
      assert find_max_earlier_departure_schedule_time([journey1, journey2, journey3], ~N[2017-03-01T06:59:00]) == nil
  ...
  describe "Journey.remove_departure_schedules_before/2" do
    test "removes journeys" do
      ...
      result1 = remove_departure_schedules_before([journey1, journey2, journey3], ~N[2017-03-01T07:10:00])
      assert result1 == [journey2, journey3]

      # [ 9:00, 8:00, 7:00 ] before 8:10 -> [ 9:00, 8:00 ]
      result2 = remove_departure_schedules_before([journey3, journey2, journey1], ~N[2017-03-01T07:10:00])
  ...
  describe "Journey.filter/3" do
    test "filters last trip and upcoming" do
      ...
      result1 = filter([journey1, journey2, journey3], :last_trip_and_upcoming, ~N[2017-03-01T07:10:00])
      assert result1 == [journey1, journey2, journey3]

      # [ 9:00, 8:00, 7:00 ] @ 8:10 -> [ 9:00, 8:00 ]
      result2 = filter([journey3, journey2, journey1], :last_trip_and_upcoming, ~N[2017-03-01T08:10:00])
      assert result2 == [journey3, journey2]

      # [ 9:00, 8:00, 7:00 ] @ 8:10 the day before -> [ 9:00, 8:00, 7:00 ]
      result2 = filter([journey3, journey2, journey1], :last_trip_and_upcoming, ~N[2017-02-28T08:10:00])
      assert result2 == [journey3, journey2, journey1]

      # [ 9:00, 8:00, 7:00 ] @ 8:10 the next day -> [ 9:00, 8:00, 7:00 ]
      result3 = filter([journey3, journey2, journey1], :last_trip_and_upcoming, ~N[2017-03-02T08:10:00])
    ...
    test "filters trips with no departure schedule" do
      ...
      assert filter([journey1, journey2], :last_trip_and_upcoming, ~N[2017-03-01T10:00:00]) == [journey1, journey2]
    end
