defmodule Site.OldSiteFileControllerTest do
  ...
  describe "redirect_through_cdn/2" do
    test "ignores the new URL, and redirects to the static_url", %{conn: conn} do
      path = "/request/path"
      expected_path = Site.Router.Helpers.static_url(Site.Endpoint, path)
      conn = Site.OldSiteFileController.redirect_through_cdn(conn, {"host", path})
