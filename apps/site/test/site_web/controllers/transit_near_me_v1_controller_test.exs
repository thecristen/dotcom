defmodule SiteWeb.TransitNearMeV1ControllerTest do
  ...
  test "it contains the google maps scripts", %{conn: conn} do
    conn =
      conn
      |> get(transit_near_me_v1_path(conn, :index))
