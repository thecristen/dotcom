defmodule SiteWeb.ScheduleController.FinderApiTest do
  ...
  describe "journeys/2" do
    ...
    test "successfully calls the API for bus", %{conn: conn} do
    ...
    test "successfully calls the API for CR", %{conn: conn} do
      date = Util.now() |> Date.to_iso8601()
    ...
    test "successfully calls the API for ferry", %{conn: conn} do
      date = Util.now() |> Date.to_iso8601()
