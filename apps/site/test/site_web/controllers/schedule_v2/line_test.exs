defmodule SiteWeb.ScheduleV2Controller.LineTest do
  use SiteWeb.ConnCase, async: true
  import SiteWeb.ScheduleV2Controller.Line
  alias Stops.{RouteStop, RouteStops}

  doctest SiteWeb.ScheduleV2Controller.Line

  @deps %SiteWeb.ScheduleV2Controller.Line.Dependencies{}
