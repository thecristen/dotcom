defmodule SiteWeb.ScheduleV2.TripListViewTest do
  use SiteWeb.ConnCase, async: true

  import SiteWeb.ScheduleV2View.TripList
  ...
  describe "frequency_times/1" do
    test "returns \"Every X mins\" if there is service during a time block" do
      ...
      rendered = frequency |> SiteWeb.ScheduleV2View.TripList.frequency_times |> safe_to_string
    ...
    test "returns \"No service between these hours\" if there is no service" do
      rendered = %Schedules.Frequency{} |> SiteWeb.ScheduleV2View.TripList.frequency_times |> safe_to_string
