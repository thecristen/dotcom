defmodule Schedules.Sort do
  ...
  @spec first_matching_schedules([Schedule.t], [Schedule.t]) :: {Schedule.t, Schedule.t} | nil
  def first_matching_schedules(left, right) do
    ...
    case Enum.find(right, &Map.has_key?(left_stops, &1.stop)) do
      nil -> nil
      matching_right_schedule -> {left_stops[matching_right_schedule.stop], matching_right_schedule}
    end
  end
