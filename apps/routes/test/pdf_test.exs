defmodule Routes.PdfTest do
  ...
  describe "url/1" do
    test "returns the MBTA url if it exists for that route" do
      ...
      assert url(route1) == "/uploadedfiles/Documents/Schedules_and_Maps/Bus/route001.pdf"
      assert url(route2) == "/uploadedfiles/Documents/Schedules_and_Maps/Commuter_Rail/fitchburg.pdf"
      assert url(route3) == "/uploadedfiles/Documents/Schedules_and_Maps/Boats/routeF4.pdf?led=7/8/2016%201:50:02%20PM"
    end
  ...
  describe "dated_urls/2" do
    test "given a date, returns upcoming schedule PDFs" do
      ...
      expected = [
        ...
        {~D[2017-05-22], "/uploadedfiles/Smart_Forms/News%2C_Events_and_Press_Releases/Fairmont%20WEB%20052217%20V1.pdf"},
      ]
    ...
    test "filters out schedules once a new one is in effect" do
      ...
      expected = [
        {~D[2017-05-22], "/uploadedfiles/Smart_Forms/News%2C_Events_and_Press_Releases/Worcester%20WEB%20052217%20V1(1).pdf"}
      ]
  ...
  describe "south_station_back_bay_pdf/1" do
    test "gives the pdf of schedules between back bay and south station when given a commuter rail line that goes to south station" do
      assert south_station_back_bay_pdf(%Route{id: "CR-Fairmount"}) == "/uploadedfiles/Documents/Schedules_and_Maps/Commuter_Rail/southstation_backbay.pdf"
    end
